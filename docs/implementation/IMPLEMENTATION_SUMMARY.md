...
#### New Documentation: [`../user/PORTFOLIO_REBALANCING_GUIDE.md`](../user/PORTFOLIO_REBALANCING_GUIDE.md)
...
### 3. Documentation: `../user/STRATEGY_README.md`
...
2. ✅ `../user/PORTFOLIO_REBALANCING_GUIDE.md` — dedicated guide
...
2. ✅ `../user/STRATEGY_README.md` (625 lines)
