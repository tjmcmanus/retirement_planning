...
- [`../user/CONFIG_GUIDE.md`](../user/CONFIG_GUIDE.md) — Configuration system guide
- [`../user/BETR_GUIDE.md`](../user/BETR_GUIDE.md) — BETR algorithm guide
- [`../user/PORTFOLIO_REBALANCING_GUIDE.md`](../user/PORTFOLIO_REBALANCING_GUIDE.md) — Rebalancing guide
- [`../user/SSI_CALCULATOR_GUIDE.md`](../user/SSI_CALCULATOR_GUIDE.md) — Social Security calculator
- [`../user/INCOME_EXPENSE_GUIDE.md`](../user/INCOME_EXPENSE_GUIDE.md) — Income/expense projections
- [`../user/STRATEGY_README.md`](../user/STRATEGY_README.md) — Withdrawal strategy details
