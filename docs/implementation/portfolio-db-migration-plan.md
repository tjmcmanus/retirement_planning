...
- The project `README` / `../user/QUICKSTART.md` notes that `portfolio.db` is the source
...
4. Update `../user/QUICKSTART.md` to note:
...
- `../user/QUICKSTART.md` — documentation to update
...
| `../user/QUICKSTART.md` | 6 | Document new data architecture |
