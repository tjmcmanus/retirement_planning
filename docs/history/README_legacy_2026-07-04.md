...
See [`docs/user/BETR_GUIDE.md`](docs/user/BETR_GUIDE.md) for complete documentation and [`betr_roth_conversion.py`](betr_roth_conversion.py) for implementation.
...
**Documentation:**
- [Market Stress Indicator Guide](docs/user/MARKET_STRESS_INDICATOR_GUIDE.md) - Complete 349-line guide with examples
...
**Documentation:**
- [Stage 7 User Guide](docs/user/STAGE7_SURVIVING_SPOUSE_GUIDE.md) - Complete 497-line guide with examples
...
**Documentation:**
- [Federal Tax Fix Details](docs/implementation/FEDERAL_TAX_FIX_2027_2029.md) - Complete analysis and fix documentation
...
**Documentation:**
- [Portfolio Factor Analysis Guide](docs/implementation/PORTFOLIO_FACTOR_ANALYSIS_GUIDE.md) - 449 lines: Complete user guide
- [Portfolio Rebalancing Guide](docs/user/PORTFOLIO_REBALANCING_GUIDE.md) - Integration with rebalancing
...
**Documentation:**
- [Phase 3 Implementation Guide](docs/implementation/PHASE3_MULTI_CURRENCY_IMPLEMENTATION.md) - Complete 1,015-line guide
- Ready for implementation when needed

**Overall Documentation:**
- [Brokerage Integration Roadmap](docs/implementation/BROKERAGE_INTEGRATION_ROADMAP.md) - 715 lines: Project overview
- [Phase 1 Complete Summary](docs/implementation/PHASE1_BROKERAGE_INTEGRATION_COMPLETE.md) - 625 lines: Phase 1 details
- [Phase 2 Complete Summary](docs/implementation/PHASE2_IMPLEMENTATION_COMPLETE.md) - 625 lines: Phase 2 details
- [Phase 2 Implementation Guide](docs/implementation/PHASE2_REALTIME_SYNC_IMPLEMENTATION.md) - 1,015 lines: Technical guide
- [Brokerage Integration Enhancements](docs/user/BROKERAGE_INTEGRATION_ENHANCEMENTS_GUIDE.md) - Original planning doc
...
- **Documentation**:
  - [`docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md`](docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md) (752 lines) — Complete integration guide
  - [`docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md`](docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md) (545 lines) — Estate tax guide with examples
...
- **Comprehensive Documentation & Testing**
  - [`docs/user/COST_BASIS_TRACKING_GUIDE.md`](docs/user/COST_BASIS_TRACKING_GUIDE.md): 678-line complete implementation guide
...
- **Documentation** — 3,845 lines of comprehensive guides
  - [`docs/user/PORTFOLIO_ANALYTICS_GUIDE.md`](docs/user/PORTFOLIO_ANALYTICS_GUIDE.md): Complete analytics reference
  - [`docs/implementation/INTEGRATION_TEST_GUIDE.md`](docs/implementation/INTEGRATION_TEST_GUIDE.md): Testing documentation
  - [`docs/implementation/PHASE1_IMPLEMENTATION_GUIDE.md`](docs/implementation/PHASE1_IMPLEMENTATION_GUIDE.md): Implementation details
  - [`docs/implementation/PHASE1_HANDOFF_DOCUMENT.md`](docs/implementation/PHASE1_HANDOFF_DOCUMENT.md): Handoff guide
...
- **Single Person Mode** — Simplified configuration for individual planning
  ...
  - See [`docs/user/SINGLE_PERSON_MODE_GUIDE.md`](docs/user/SINGLE_PERSON_MODE_GUIDE.md) for complete documentation
...
- **Age-Based Healthcare Cost Adjustments** — Inverse relationship to general expenses
  ...
  - See [`docs/user/AGE_BASED_EXPENSES_GUIDE.md`](docs/user/AGE_BASED_EXPENSES_GUIDE.md) for methodology and research
...
- **Comprehensive Documentation**
  - [`docs/implementation/LTC_PLANNING_GUIDE.md`](docs/implementation/LTC_PLANNING_GUIDE.md) — 745-line complete LTC planning guide
  - [`docs/implementation/HSA_INTEGRATION_GUIDE.md`](docs/implementation/HSA_INTEGRATION_GUIDE.md) — 925-line complete HSA guide
...
See [`docs/implementation/LTC_PLANNING_GUIDE.md`](docs/implementation/LTC_PLANNING_GUIDE.md) and [`docs/implementation/HSA_INTEGRATION_GUIDE.md`](docs/implementation/HSA_INTEGRATION_GUIDE.md) for complete documentation.
...
See [`docs/user/PORTFOLIO_REBALANCING_GUIDE.md`](docs/user/PORTFOLIO_REBALANCING_GUIDE.md) for full documentation.
...
See [`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md) for complete configuration documentation.
...
See [`docs/user/STRATEGY_README.md`](docs/user/STRATEGY_README.md) for complete documentation.
...
- See [`docs/user/LOGGING_GUIDE.md`](docs/user/LOGGING_GUIDE.md) for usage
...
- See [`docs/implementation/ERRORS_FOUND.md`](docs/implementation/ERRORS_FOUND.md) for details
...
**Documentation:**
- [`docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md`](docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md) (752 lines) — Complete integration guide with examples
- [`docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md`](docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md) (545 lines) — Estate tax guide with strategies and FAQ
...
See [`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md), [`docs/implementation/LTC_PLANNING_GUIDE.md`](docs/implementation/LTC_PLANNING_GUIDE.md), and [`docs/implementation/HSA_INTEGRATION_GUIDE.md`](docs/implementation/HSA_INTEGRATION_GUIDE.md) for detailed instructions.
...
See [`docs/user/PORTFOLIO_ANALYTICS_GUIDE.md`](docs/user/PORTFOLIO_ANALYTICS_GUIDE.md) for complete analytics documentation and [`docs/implementation/INTEGRATION_TEST_GUIDE.md`](docs/implementation/INTEGRATION_TEST_GUIDE.md) for testing details.
...
2. **Configure Your Settings** - Navigate to the Configuration page (⚙️ icon)
   ...
   - See [`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md) for detailed setup instructions
...
- **`portfolio_data_truth.csv`**: Portfolio holdings with monthly snapshots
  ...
  - See [`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md) for detailed data entry instructions
...
The application now uses a centralized configuration system. See [`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md) for complete documentation.
...
├── docs/user/CONFIG_GUIDE.md                    # Configuration system guide
├── docs/user/BETR_GUIDE.md                      # BETR Roth conversion guide
├── docs/user/SSI_CALCULATOR_GUIDE.md            # SSI calculator documentation
├── docs/implementation/SSI_INTEGRATION_GUIDE.md           # SSI integration with withdrawal strategy
├── docs/user/STRATEGY_README.md                 # Withdrawal strategy documentation
├── docs/user/PORTFOLIO_REBALANCING_GUIDE.md     # ⚖️ NEW: Portfolio rebalancing guide
├── docs/implementation/IMPLEMENTATION_SUMMARY.md          # Implementation details
├── docs/implementation/ACCOUNT_REBALANCING_IMPLEMENTATION.md  # Account rebalancing feature
├── docs/implementation/BETR_CORRECTION_NOTES.md           # BETR algorithm corrections
├── docs/implementation/ERRORS_FOUND.md                    # Bug fixes and code analysis
├── docs/user/LOGGING_GUIDE.md                   # Debug logging guide
├── docs/implementation/DOCUMENTATION_REVIEW_SUMMARY.md    # Documentation review and gaps
...
**See Also:** [`docs/user/SSI_CALCULATOR_GUIDE.md`](docs/user/SSI_CALCULATOR_GUIDE.md), [`docs/implementation/SSI_INTEGRATION_GUIDE.md`](docs/implementation/SSI_INTEGRATION_GUIDE.md)
...
- **[`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md)** - Configuration system guide
  ...
  - API reference
  - Troubleshooting
- **[`docs/user/STRATEGY_README.md`](docs/user/STRATEGY_README.md)** - Complete withdrawal strategy guide
  - Installation and setup
  - API documentation
  - Strategy explanations for each life stage
  - Tax optimization techniques
  - Integration examples
- **[`docs/user/BETR_GUIDE.md`](docs/user/BETR_GUIDE.md)** - BETR Roth conversion guide
...
- **[`docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md`](docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md)** - Complete estate planning integration guide (752 lines)
...
- **[`docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md`](docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md)** - Estate tax calculations guide (545 lines)
...
- **[`docs/user/COST_BASIS_TRACKING_GUIDE.md`](docs/user/COST_BASIS_TRACKING_GUIDE.md)** - Cost basis tracking implementation guide (678 lines)
...
- **[`docs/implementation/LTC_PLANNING_GUIDE.md`](docs/implementation/LTC_PLANNING_GUIDE.md)** - Long-Term Care planning guide
...
- **[`docs/implementation/HSA_INTEGRATION_GUIDE.md`](docs/implementation/HSA_INTEGRATION_GUIDE.md)** - Health Savings Account guide
...
- **[`docs/implementation/BACKDOOR_ROTH_STRATEGY.md`](docs/implementation/BACKDOOR_ROTH_STRATEGY.md)** - Backdoor Roth IRA strategy guide
...
- **[`docs/implementation/MEGA_BACKDOOR_ROTH_STRATEGY.md`](docs/implementation/MEGA_BACKDOOR_ROTH_STRATEGY.md)** *(NEW)* - Mega backdoor Roth strategy guide
...
- **[`docs/implementation/BROKERAGE_INTEGRATION_SUMMARY.md`](docs/implementation/BROKERAGE_INTEGRATION_SUMMARY.md)** - Complete brokerage integration guide (752 lines)
  ...
  - Future enhancement roadmap
- **[`docs/user/SNAPTRADE_QUICKSTART.md`](docs/user/SNAPTRADE_QUICKSTART.md)** - SnapTrade setup guide (330 lines)
  - Quick start instructions
  - Multi-brokerage aggregation (5,000+ institutions)
  - Automatic daily sync
  - OAuth 2.0 authentication
  - Transaction import and cost basis tracking
- **[`docs/implementation/SNAPTRADE_IMPLEMENTATION_SUMMARY.md`](docs/implementation/SNAPTRADE_IMPLEMENTATION_SUMMARY.md)** - Technical implementation (450 lines)
  - Architecture overview
  - Component descriptions
  - API integration patterns
  - Testing guide
- **[`docs/user/SCHWAB_INTEGRATION_GUIDE.md`](docs/user/SCHWAB_INTEGRATION_GUIDE.md)** - Schwab direct API guide (476 lines)
  - Developer account setup
  - OAuth 2.0 configuration
  - Direct API integration
  - Advanced transaction import
  - Cost basis tracking (FIFO method)
- **[`docs/implementation/SCHWAB_DIRECT_API_IMPLEMENTATION_COMPLETE.md`](docs/implementation/SCHWAB_DIRECT_API_IMPLEMENTATION_COMPLETE.md)** - Implementation summary (560 lines)
  - Complete feature list
  - Architecture details
  - Testing results
  - Known limitations
- **[`docs/implementation/SCHWAB_TRANSACTION_IMPORT_IMPLEMENTATION.md`](docs/implementation/SCHWAB_TRANSACTION_IMPORT_IMPLEMENTATION.md)** - Transaction import guide (557 lines)
...
- **[`docs/user/PORTFOLIO_REBALANCING_GUIDE.md`](docs/user/PORTFOLIO_REBALANCING_GUIDE.md)** *(NEW)* - Portfolio rebalancing guide
...
- **[`docs/user/PORTFOLIO_ANALYTICS_GUIDE.md`](docs/user/PORTFOLIO_ANALYTICS_GUIDE.md)** - Complete portfolio analytics reference (545 lines)
  ...
  - Complete API reference with examples
- **[`docs/implementation/INTEGRATION_TEST_GUIDE.md`](docs/implementation/INTEGRATION_TEST_GUIDE.md)** - Integration testing documentation (445 lines)
...
- **[`docs/implementation/PHASE1_IMPLEMENTATION_GUIDE.md`](docs/implementation/PHASE1_IMPLEMENTATION_GUIDE.md)** - Implementation details (424 lines)
  - Component architecture and design decisions
  - Development timeline and milestones
  - Technical implementation details
  - Integration patterns
- **[`docs/implementation/PHASE1_HANDOFF_DOCUMENT.md`](docs/implementation/PHASE1_HANDOFF_DOCUMENT.md)** - Handoff guide (687 lines)
  - Complete feature overview
  - User workflows and use cases
  - Maintenance and troubleshooting guide
  - Future enhancement roadmap
- **[`docs/implementation/PORTFOLIO_ENHANCEMENTS_IMPLEMENTATION_SUMMARY.md`](docs/implementation/PORTFOLIO_ENHANCEMENTS_IMPLEMENTATION_SUMMARY.md)** - Implementation summary (445 lines)
  - Feature comparison (before vs. after)
  - Technical architecture overview
  - Performance improvements
- **[`docs/implementation/PORTFOLIO_UX_REDESIGN_PROPOSAL.md`](docs/implementation/PORTFOLIO_UX_REDESIGN_PROPOSAL.md)** - UX redesign proposal (687 lines)
  - User research and pain points
  - Design principles and goals
  - Proposed solutions and mockups
- **[`docs/implementation/OPTIMIZATION_COMPONENT_IMPLEMENTATION.md`](docs/implementation/OPTIMIZATION_COMPONENT_IMPLEMENTATION.md)** - Optimization component guide (487 lines)
...
- **[`docs/user/PERFORMANCE_OPTIMIZATION_GUIDE.md`](docs/user/PERFORMANCE_OPTIMIZATION_GUIDE.md)** - Performance optimization guide (745 lines)
...
- **[`docs/implementation/IMPLEMENTATION_SUMMARY.md`](docs/implementation/IMPLEMENTATION_SUMMARY.md)** - Development summary
  - What was built
  - Key capabilities
  - Technical architecture
  - Test results
  - Integration points
- **[`docs/implementation/ACCOUNT_REBALANCING_IMPLEMENTATION.md`](docs/implementation/ACCOUNT_REBALANCING_IMPLEMENTATION.md)** - Strategy-level account rebalancing (buffer maintenance)

### Technical Guides
- **[`docs/user/LOGGING_GUIDE.md`](docs/user/LOGGING_GUIDE.md)** - Debug logging configuration
  - Enabling debug output
  - Log levels and format
  - Functions with logging
  - Usage examples

- **[`docs/implementation/ERRORS_FOUND.md`](docs/implementation/ERRORS_FOUND.md)** - Bug fixes and code analysis
  - Fixed syntax errors
  - Code quality observations
  - Testing recommendations
  - Security considerations

- **[`docs/implementation/DOCUMENTATION_REVIEW_SUMMARY.md`](docs/implementation/DOCUMENTATION_REVIEW_SUMMARY.md)** - Documentation gap analysis and action items
...
See [`docs/implementation/ERRORS_FOUND.md`](docs/implementation/ERRORS_FOUND.md) for complete analysis.
...
See [`docs/user/LOGGING_GUIDE.md`](docs/user/LOGGING_GUIDE.md) for complete logging documentation.
...
2. **Start with Configuration**: See [`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md) for setup instructions
...
8. Review documentation files for detailed guidance:
   - [`docs/user/CONFIG_GUIDE.md`](docs/user/CONFIG_GUIDE.md) - Configuration system (NEW)
   - [`docs/user/STRATEGY_README.md`](docs/user/STRATEGY_README.md) - Withdrawal strategies
   - [`docs/user/LOGGING_GUIDE.md`](docs/user/LOGGING_GUIDE.md) - Debug logging
   - [`docs/implementation/ERRORS_FOUND.md`](docs/implementation/ERRORS_FOUND.md) - Bug fixes
   - [`docs/implementation/IMPLEMENTATION_SUMMARY.md`](docs/implementation/IMPLEMENTATION_SUMMARY.md) - Technical details
...
- `docs/user/WITHDRAWAL_STRATEGY_PRODUCTION_GUIDE.md` - Complete documentation (733 lines)
...
**See:** `docs/user/WITHDRAWAL_STRATEGY_PRODUCTION_GUIDE.md` for complete usage guide
...
- **Documentation** (1,297 lines):
  - [`docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md`](docs/implementation/ADVANCED_ESTATE_PLANNING_GUIDE.md) (752 lines) — Complete integration guide
  - [`docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md`](docs/user/ESTATE_TAX_CALCULATIONS_GUIDE.md) (545 lines) — Estate tax guide
...
#### 8. Scenario Planning & What-If Analysis ✅ IMPLEMENTED (April 2026)
**Priority: Low - Enhances planning flexibility**

Compare multiple retirement scenarios side-by-side with comprehensive life event modeling. Explore "what-if" questions and make data-driven retirement decisions.

- **Interactive Scenarios** ✅
  - Side-by-side scenario comparison (up to 4 scenarios)
  - Real-time parameter adjustment with instant recalculation
  - Scenario saving and loading (JSON-based persistence)
  - Scenario sharing via URL parameters (base64 encoding)
  - Baseline scenario tracking
  - Scenario cloning and editing

- **Life Event Modeling** ✅
  - **14 Pre-defined Templates:**
    ...
    - Relocation
    - Custom events
  - Event impact calculations (income, expenses, portfolio, taxes)
  - Event timeline visualization
  - Conflict detection

- **Comprehensive Analysis** ✅
  - Portfolio trajectory comparison charts
  - Success probability comparison
  - Cash flow analysis with life events
  - Parameter comparison tables
  - Monte Carlo integration (5,000 simulations per scenario)
  - Export to CSV/JSON

**Access:** Navigate to 🎯 Scenario Planning page

**Documentation:** See `docs/implementation/SCENARIO_PLANNING_IMPLEMENTATION.md` for technical details
...
- **Documentation** - `docs/user/SS_OPTIMIZATION_GUIDE.md` (545 lines)
...
- ⚙️ [Configuration Guide](docs/user/CONFIG_GUIDE.md) - **START HERE**
- 💰 [BETR Roth Conversion Guide](docs/user/BETR_GUIDE.md) - **NEW**
- 📖 [Withdrawal Strategy Guide](docs/user/STRATEGY_README.md)
- 🔧 [Implementation Summary](docs/implementation/IMPLEMENTATION_SUMMARY.md)
- 🐛 [Bug Fixes & Analysis](docs/implementation/ERRORS_FOUND.md)
- 📝 [Logging Guide](docs/user/LOGGING_GUIDE.md)
- 🚀 [Run Main App](run.sh)
