...
See [`SSI_INTEGRATION_GUIDE.md`](SSI_INTEGRATION_GUIDE.md) for full SSI integration details.
...
- [`SSI_INTEGRATION_GUIDE.md`](SSI_INTEGRATION_GUIDE.md) — SSI dynamic calculation details
