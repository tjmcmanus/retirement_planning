...
For technical details, see the [API Documentation](SCENARIO_PLANNING_API.md).

For implementation details, see the [Implementation Plan](SCENARIO_PLANNING_IMPLEMENTATION.md).
